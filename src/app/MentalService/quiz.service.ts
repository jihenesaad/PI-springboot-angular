...
export class QuizService {
  ...
  calculateQuizScore(selectedAnswerIds: number[], idQuiz: number, idUser: number): Observable<number> {
    return this.http.post<number>(`${this.baseUrl}/calculateQuizScore/${idQuiz}/${idUser}`, selectedAnswerIds);
}
